...
from src.features import process_numerical_features, drop_features
...
def main_command(config_path: str):
    ...
    process_data(training_params.input_data_path, training_params.output_proccessed_data_path, training_params.feature_params)
